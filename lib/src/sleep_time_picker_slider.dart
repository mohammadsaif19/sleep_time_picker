...
///
///     SleepTimePicker(5, 10, onSelectionChange: () => {});
class SleepTimePicker extends StatefulWidget {
  ...
  SleepTimePicker(
    ...
    this.activeTimeFontSize = 13,
    this.timeFontSize = 12,
    this.activeTimeColor = Colors.white,
    this.timeColor = const Color(0xFFD3D4D6),
    this.textStyle,
      ...
      child: Stack(
        children: [
          Container(
            ...
            width: widget.width ?? 220,
            child: CustomPaint(
              painter: TimeTextPainter(
                activeTimeFontSize: widget.activeTimeFontSize,
                activeTimeColor: widget.activeTimeColor,
                timeFontSize: widget.timeFontSize,
